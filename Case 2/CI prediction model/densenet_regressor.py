...
from custom_densenet import DenseNet
import custom_densenet
...
model_ft: DenseNet = custom_densenet.densenet161(pretrained=False)
...
# save model
torch.save(model_ft.state_dict(), "./result_model/densenet2.pth")
