...
# trainset = DEMDataset(r'F:\C++\linux\aigis\peakpoint\model\test2\train.csv',
#                       r'F:\C++\linux\aigis\peakpoint\model\test2\sample_image',
...
#                           Normalize(mean, std)
#                       ]))
# testset = DEMDataset(r'F:\C++\linux\aigis\peakpoint\model\test2\test.csv',
#                       r'F:\C++\linux\aigis\peakpoint\model\test2\sample_image',
#                      transform=transforms.Compose([
...
# save model
torch.save(model_ft.state_dict(), "./result_model/alexnet3.pth")
